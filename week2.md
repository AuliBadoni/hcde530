...
*Reflection notes — edit freely before submitting.*
...
Replace the placeholders with your **actual** history (newest first is fine).

1. *(paste commit subject + optional body)*
2. *(paste)*
3. *(paste)*

**Example of a strong message** (pattern only—use your real work):  
`Fix demo_word_count preview: truncate responses over 60 chars so terminal table stays readable`
...
*(What still felt fuzzy — optional to add in your own words: e.g. `build_dashboard.py`, regex, JSON embedding in HTML.)*
...
*Status: draft you can tighten or paste into Canvas if your assignment asks for evidence.*

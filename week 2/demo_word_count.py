...
# Load the CSV file next to this script (works from any working directory)
filename = os.path.join(os.path.dirname(__file__), "demo_responses.csv")
responses = []
...
if word_counts:
    ...
    print("  (No response rows — no word-length statistics.)")
